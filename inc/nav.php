	<header class="header">
		<div class="container">
			<div class="logo pull-left">
				<a href="index.php">
					<img src="img/resources/logo.png" alt="TR Logo" />
				</a>
			</div>
					...
					<ul>
						...
						<li class="dropdown"><a href="about.php">About Us</a>
							<ul class="submenu">
								...
								<li><a href="mentors.php">Our Mentors</a></li>
						...
						<li>
						<div class="text-center"><a href="#" class="thm-btn mt_30 mb_30">SIGN UP</a>&nbsp;&nbsp;</div>
						</li>
						<li>
						<div class="text-center"><a href="#" class="thm-btn mt_30 mb_30">Volunteer</a></div>
                        </li>
					</ul>
				</div>
